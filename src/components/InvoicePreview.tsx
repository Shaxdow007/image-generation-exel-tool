      ...
      <div className="p-8 text-sm">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm mt-2">
            {companyInfo.address || "Adresse de votre entreprise"}
          </p>
        ...
        <table className="w-full border-collapse border border-gray-400 mb-6 text-xs">
          <thead>
            <tr>
              <th className="border border-gray-400 p-2 text-left bg-gray-100">
                Référence
              </th>
              <th className="border border-gray-400 p-2 text-left bg-gray-100">
                Désignation
              </th>
              <th className="border border-gray-400 p-2 text-center bg-gray-100">
                Qté
              </th>
              <th className="border border-gray-400 p-2 text-center bg-gray-100">
                Ct
              </th>
              <th className="border border-gray-400 p-2 text-right bg-gray-100">
                P.U HT
              </th>
              <th className="border border-gray-400 p-2 text-right bg-gray-100">
                Montant HT
        ...
        <div className="flex justify-between items-end">
          <div className="text-xs">
            ...
            <p className="mt-2">
              Quantité:{" "}
              <strong> {formatCurrency(invoice.totalQuantity)}</strong>
            </p>
          </div>
          ...
          <div className="text-right">
            ...
            <div className="border border-gray-400 p-3 mb-2 text-center min-w-32">
              ...
              <div>{`${formatCurrency(invoice.advance)}***`}</div>
            </div>
